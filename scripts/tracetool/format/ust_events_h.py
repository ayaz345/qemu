...
def generate(events, backend, group):
    ...
    include = "trace-ust-all.h" if group == "all" else "trace-ust.h"
    out(
        ...
        f'#define TRACEPOINT_INCLUDE "./{include}"',
        '',
        '#if !defined (TRACE_%s_GENERATED_UST_H) || \\' % group.upper(),
        '     defined(TRACEPOINT_HEADER_MULTI_READ)',
        f'#define TRACE_{group.upper()}_GENERATED_UST_H',
        '',
    ...
    out(
        f'#endif /* TRACE_{group.upper()}_GENERATED_UST_H */',
        '',
